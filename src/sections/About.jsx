    ...
    <section className='c-space section-spacing'>
        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12' >
            <div className='flex items-end grid-default-color grid-1'>
                ...
                <div className='z-10'>
                    <p className='headtext'>Hey, I'm Suhani Mishra</p>
                    <p className='subtext'>Over the past 4 years, I developed my frontend and 
                        backend dev 
            ...
            <div className='grid-default-color grid-2'>
                <div ref={grid2Container} className='flex items-center justify-center w-full h-full'>
                    ...
                    <Card style={{rotate: "30deg", top:"70%", left:"70%"}} image="assets/logos/cplusplus.svg" containerRef={grid2Container} />
                    <Card style={{rotate: "-45deg", top:"70%", left:"25%"}} image="assets/logos/react.svg" containerRef={grid2Container} />
                    <Card style={{rotate: "-45deg", top:"5%", left:"10%"}} image="assets/logos/javascript.svg" containerRef={grid2Container} />
                </div>
            </div>
            ...
            <div className='grid-default-color grid-5'>
                <div className='z-10 w-[50%]'>
                    ...
                    <p className='subtext'>I specialize in a variety of languages, frameworks
                        and tools that 
                        allow me to build robust & scalable applications
                    </p>
                </div>
